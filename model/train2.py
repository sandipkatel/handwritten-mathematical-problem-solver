...
processor = AutoProcessor.from_pretrained("microsoft/trocr-base-handwritten") #"microsoft/trocr-base-handwritten"
...
model = VisionEncoderDecoderModel.from_pretrained("microsoft/trocr-base-handwritten") #microsoft/trocr-base-stage1
...
training_args = Seq2SeqTrainingArguments(
    ...
    eval_strategy="steps",
    per_device_train_batch_size=6, #origin 8
...
class CustomTrainer(Seq2SeqTrainer):
    def compute_loss(self, model, inputs, return_outputs=False, **kwargs):
        # Remove 'num_items_in_batch' if it exists
